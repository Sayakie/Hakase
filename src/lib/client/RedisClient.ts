...
export type RedisKeyQuery<K extends RedisKey> = K extends 'getPokemon' ? Species : null

export type RedisData<K extends RedisKey> = K extends 'getPokemon' ? Species : null
